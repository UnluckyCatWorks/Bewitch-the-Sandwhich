...
public abstract class BCharacter : MonoBehaviour
{
	#region DATA
	[Header("Player info")]
	public int id;
	...
	private void CheckInteractions () 
	{
		...
		{
            var interactable = hit.collider.GetComponent<BInteractable>();
	...
	{
		var prefix = controller.ToString()[0];
